...
\hypersetup{
  ...
  pdfauthor={Jesús Moreno León, Gregorio Robles},
...
{\tiny
(cc) 2014 Gregorio Robles and Jesús Moreno León\\
...
%--------------------------------------------------------
\usebackgroundtemplate{\includegraphics[width=19cm]{figs/AngryBirds.png}}

\begin{frame}
\frametitle{Goal of our paper}

\begin{center}
\Huge Are bad programming habits a common practice in the Scratch community?
\end{center}
...
\begin{itemize}
  \item Educators teaching to code
  \item Students learning to code
  \item Programming learning tools developers
\end{itemize} 
...
\begin{itemize}
  \item Success to teach both basic and advanced programming concepts
  \item Bad programming habits detected
  \item Lack of automatic tools to check for \textit{correctness}
  \item Hairball: Lint-inspired Static Analysis of Scratch Projects
\end{itemize}
    \end{block}
    \end{column}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Bad programming habits with Scratch: objects naming}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Bad programming habits with Scratch: repetition code}

\begin{figure}[t!]
\begin{center}
\includegraphics[width=6cm,height=2.7cm]{figs/CodeRepetition1.png}
\end{center}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[width=6cm,height=2.7cm]{figs/CodeRepetition2.png}
\end{center}
\label{fig:repetition2}
\end{figure}

\begin{center}
Creating blocks to avoid repetition code
\end{center}
...
We developed two plug-ins for Hairball to automatically detect bad programming habits:
\begin{itemize}
...
\begin{center}
  ...
  \end{tabular}
\end{center}
\caption{Analysis of 100 ramdonly downloaded projects}
\label{table:results}
\end{table}
\end{frame}
...
\begin{itemize}
  ...
  \item Analyze dataset with 5 years data from Scratch website
  \item Dr.Scratch: http://drscratch.programamos.es
\end{itemize}
\vspace{\baselineskip}
\vspace{\baselineskip}
